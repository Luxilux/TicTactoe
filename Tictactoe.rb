...
class Board
  ...
  def player_one
    ...
    print_grid
    puts "Joueur 1 choisissez une case"
    ...
    case input 
      ...
      when "c3" 
        @c3.value = "X"
      else puts "Ce que tu viens d'écrire n'est pas valide, essayez encore :"
        player_one
      end
  ...
  def player_two
    ...
    print_grid
    puts "Joueur 2, choisissez une case"
    input = gets.chomp.downcase
    case input 
      when "a1" 
        @a1.value = "O"
...
class Game
  def initialize
    ...
    puts "Pour quitter la partie, fais Ctrl + c "
    puts "Pour placer ton X ou ton 0, choisi ta cellule (par exemple a1 ou b3)."
